...
public:
  ...
  void geBackward(const int &startind, const int & endind,
  ...
  void cnForward(const int & startind, const int & endind, double tii[],
                 double tit[], double s[], double e[]);

  void geForward(const int &startind, const int & endind, double t[],
                 double dx[], double cn[], double cap[],
                 double s[], double e[], double & dt);

  // using the updated Arrays E and S to update the soil temperature*/
  void cnBackward(const int & startind, const int & endind, double tii[],
                  double tit[], double s[], double e[]);

  void tridiagonal(const int ind, const int numsl, double a[], double b[],
                   double c[], double r[], double u[]);
};
