...
void Ground::initSnowSoilLayers() {
  ...
  organic.ShlwThickScheme(organic.shlwthick, organic.shlwthick+organic.deepthick); //fibthick in m, which needs input
  organic.DeepThickScheme(organic.deepthick, organic.shlwthick+organic.deepthick); //humthick in m, which needs input
...
COMBINEBEGIN:
    ...
    organic.ShlwThickScheme(organic.shlwthick, organic.shlwthick+organic.deepthick);
    ...
    //if(bd->m_v2soi.ltrfalcall > 0.0){
      ...
      organic.ShlwThickScheme(thick, organic.shlwthick+organic.deepthick);
...
void Ground::redivideDeepLayers() {
  ...
  if(fstdeepl != NULL) {
    ...
    organic.DeepThickScheme(organic.deepthick, organic.shlwthick+organic.deepthick); //here, 'Soil Horizons'
                                                // info has updated
    ...
    if (somc>=deepcmin) {
      organic.DeepThickScheme(MINDEPTHICK, organic.shlwthick+organic.deepthick);
