...
void write_sample_parallel_io(int id, int ntasks) {

#ifndef WITHMPI
    std::cout << "DO NOTHING! Can't try parallel file IO if not compiled with -DWITHMPI " << std::endl; 
#else
    int ncid;
...
int main(int argc, char* argv[]){
  ...
  */
    ...
    write_sample_parallel_io(id, ntasks);
