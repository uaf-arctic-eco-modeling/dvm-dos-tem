...
void BgcOutputer::outputCohortBgcVars_mly(const int &ipft, BgcData *bd,
                                          FirData *fd, const int &calyr,
                                          const int &calmon,
                                          const int & tstepcnt) {
...
void BgcOutputer::outputCohortBgcVars_yly(const int &ipft, BgcData *bgcod,
                                          FirData *fd, const int &calyr,
                                          const int & tstepcnt) {
  NcError err(NcError::verbose_nonfatal);
