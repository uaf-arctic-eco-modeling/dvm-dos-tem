...
// the following index MUST be exactly match up with the var list in
// "outvarlist.txt" located in /config/
// this list of index is used in 'OutTrieve::OutRegnBuffer.ccp' and
// 'RegnOutputer.cpp'
