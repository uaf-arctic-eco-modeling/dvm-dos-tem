 ...
 *   (2) Eventually we hope to force using an external or integrated state and transition model
 *
 ...
 *         Ground::adjustSoilAfterThermokarst()
 *
...
void Thermokarst::getBurnAbgVegetation(const int ipft, const int year) {
