...
#PFT2
#new_bounds = [[10,15], [-5., -3.], [-7.0, -5.0], [-7.0, -5.0], [0.14, 0.20], [0.001, 0.005], [0.001, 0.005],
#             [0.0001,0.001], [0.0002, 0.0004], [0.0001, 0.0005]]

#PFT1
#new_bounds = [[0.5,1.], [-3.5, -3.], [-6., -5.5], [-6, -5.], [0.07, 0.09], [0.0005, 0.0007], [0.0003, 0.0007],
#               [0.005,0.01], [0.0001, 0.0005], [0.0001, 0.0004]]

#PFT4
#new_bounds = [[1, 5], [-3.8, -2.8], [-6.3, -5.3], [-6.3, -5.3], [0.04, 0.09], [0.0004, 0.0008], [0.0004, 0.0008],
#              [0.001,0.003], [0.0001, 0.0003], [0.0001, 0.0003]]

#PFT3
#new_bounds = [[0.1, 5], [-5, -3.5], [-7, -6], [-6, -5], [0.01, 0.02], [0.0002, 0.02], [0.002, 0.01],
#              [0.0001,0.0005], [0.0006, 0.002], [0.0006, 0.002]]

#PFT0
new_bounds = [[5.5, 6.5], [-4., -3.], [-6.5, -5.5], [-6.5, -5.5], [0.25, 0.35], [0.0003, 0.0008], [0.0006, 0.001],
              [0.001,0.008], [0.001, 0.008], [0.001, 0.008]]

#customize bounds
#STEP 1
#new_bounds=[[3.7, 4.3], [63, 68], [790,825], [5, 8], [8, 12]]
