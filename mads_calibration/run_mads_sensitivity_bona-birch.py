...
#PFT2
#new_bounds = [[1,30], [-10, -6], [-6, -2.5], [-6.0, -1.5], [0.14, 0.20], [0.0007, 0.007], [0.0007, 0.0045],
#              [0.0001,0.001], [0.001, 0.002], [0.00001, 0.0005]]

#PFT1
#new_bounds = [[1,10], [-9, -6], [-5.2, -3.5], [-5, -0.1], [0.008, 0.01], [0.035, 0.04], [0.01, 0.04],
#               [0.005,0.01], [0.001, 0.005], [0.001, 0.004]]

#PFT4
new_bounds = [[1, 10], [-11, -7], [-5, -4.1], [-3.9, -2.7], [0.005, 0.01], [0.005, 0.011], [0.003, 0.008],
...
#PFT0
#new_bounds = [[5.5, 6.5], [-7, -4], [-7.5, -6.5], [-6, -5], [0.03, 0.046], [0.008, 0.01], [0.005, 0.01],
