...
new_bounds = [[0.2, 0.7],[0.85, 0.95],[0.6, 0.85],[0.02, 0.028],[1e-9, 1e-6]]

#PFT2
#new_bounds = [[3.5,4.5], [-8, -7.2], [-5.0, -4.2], [-5.0, -4.5], [0.0000031, 0.00001], [0.008, 0.012], [0.008, 0.012],
#              [0.0001,0.001], [0.001, 0.002], [0.00001, 0.0005]]

#PFT1
#new_bounds = [[1,10], [-9, -6], [-4.75, -4], [-5, -0.1], [0.0000001, 0.000001], [0.01, 0.02], [0.005, 0.015],
...
#PFT0
#new_bounds = [[1.5, 15.5], [-2.8, -2.5], [-18, -10], [-15, -5], [0.04, 0.045], [0.000001, 0.000004], [0.000001, 0.00002],
#              [0.003,0.01], [0.0006, 0.006], [0.001, 0.01]]

#customize bounds
#STEP 1
#new_bounds=[[405, 420], [273, 278], [174,178], [995, 1003], [101, 103]]
