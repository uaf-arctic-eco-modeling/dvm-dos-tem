...
new_bounds = [[0.2, 2.9],[0.7, 0.8],[0.4, 0.7],[0.001, 0.013],[1e-10, 0.0008]]

#PFT2
#new_bounds = [[3.5,4.5], [-8, -7.2], [-4.2, -3.8], [-5.0, -4.5], [0.0000081, 0.00003], [0.01, 0.015], [0.01, 0.015],
#              [0.0001,0.001], [0.001, 0.002], [0.00001, 0.0005]]

#PFT1
#new_bounds = [[1,10], [-10, -7.2], [-4.75, -4], [-5, -0.1], [0.00001, 0.000075], [0.01, 0.02], [0.005, 0.015],
#               [0.000001,0.00001], [0.001, 0.005], [0.001, 0.004]]
...
#PFT0
#new_bounds = [[1.5, 15.5], [-3.2, -2.7], [-18, -10], [-15, -5], [0.035, 0.045], [0.00002, 0.00006], [0.000008, 0.00004],
#              [0.008,0.02], [0.0006, 0.006], [0.001, 0.01]]

#customize bounds
#STEP 1
#new_bounds=[[351, 353], [240, 245], [150,160], [937, 939], [98.5, 99.5]]
