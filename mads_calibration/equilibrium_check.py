...
results_eco.to_csv(os.path.join(path_SA + eco_file), sep=',',index=False)
...
good_df_param.to_csv(os.path.join(path_SA + 'good_df_param'), sep=',',index=False)
good_df_model.to_csv(os.path.join(path_SA + 'good_df_model'), sep=',',index=False)
