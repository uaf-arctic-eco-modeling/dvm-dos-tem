...
#SBATCH --job-name="tbc-test-dvmdostem"
...
echo "==============================================="
mpirun --mca btl self,tcp --mca btl_tcp_if_include eth2 --mca oob_tcp_if_include eth2 -n 128 ./dvmdostem -l disabled -p 100 -e 1000 -s 250 -t 109 -n 91 
