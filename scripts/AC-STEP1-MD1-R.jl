...
dvmdostem.work_dir='/data/workflows/STEP1-MD1-R'
...
md = Mads.createproblem(initial_guess, obs, TEM_pycall;
    ...
    paramdist=["Uniform(300, 450)","Uniform(80, 140)","Uniform(150, 250)","Uniform(50, 150)"],
    obstime=obs_time,
    obsweight=[100,100,100,100],
    problemname="STEP1-MD1-R-EJ")
...
Mads.spaghettiplot(md, forward_predictions,
                       xtitle="# of observations", ytitle="GPP",filename="STEP1-MD1-R-matchplot.png")
