...
VARlist=['BURNSOIL2AIRC','BURNVEG2AIRC','BURNVEG2DEADC','DWDRH', 'BURNAIR2SOIN','BURNSOILN','BURNVEG2AIRN','BURNVEG2DEADN']
...
ts_stock(POD,PODlist,VARlist,scenariolist,colorlist,widthlist,'nitrogen','Yearly Nitrogen Stock Time Series')
