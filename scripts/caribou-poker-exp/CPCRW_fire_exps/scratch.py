...
sns.lineplot(data=rh_layer_yearly.loc[rh_layer_yearly['layer']==1], x='year', y='RH', hue='layer', ax=axes[0])
sns.lineplot(data=lwc_layer_yearly.loc[lwc_layer_yearly['layer']==1], x='year', y='LWCLAYER', hue='layer', ax=axes[1])
sns.lineplot(data=t_layer_yearly.loc[t_layer_yearly['layer']==1], x='year', y='TLAYER', hue='layer', ax=axes[2])


fig, axes = plt.subplots(2,1)
sns.lineplot(data=rh_layer_yearly.loc[(rh_layer_yearly['layer']>1) & (rh_layer_yearly['layer']<5)], 
             x='year', y='RH', hue='layer', ax=axes[0])
sns.lineplot(data=lwc_layer_yearly.loc[(lwc_layer_yearly['layer']>1) & (lwc_layer_yearly['layer']<5)], 
             x='year', y='LWCLAYER', hue='layer', ax=axes[1])
