...
params = [#'bulkden(m)', 'bulkden(m)', 'bulkden(m)',
          'hksat(m)','hksat(f)','hksat(h)',
...
bounds = [#[22000,28000],[58000, 63000],[190000, 210000],
          [0.05, 0.2], [0.05, 0.2], [0.00040, 0.0020], #[0.000040, ]
          [0.15, 0.35], [0.1, 0.3], [0.1, 0.3],
          [0.94, 0.98], [0.78, 0.82], [0.7, 0.8],
          [0.5, 1.0], [0.3, 1.0],
          [1.6, 2.4]]
...
driver.design_experiment(Nsamples = 50, cmtnum = 13, params = params,
