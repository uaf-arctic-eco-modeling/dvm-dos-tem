...
def cmdline_run(args):
  ...
  config['IO']['hist_climate_file']    = os.path.join(input_data_path, 'historic-climate_time_fixed.nc')
  #config['IO']['hist_climate_file']    = os.path.join(input_data_path, 'historic-climate.nc')
  config['IO']['proj_climate_file']    = os.path.join(input_data_path, 'projected-climate_CC_CCSM4_85_Pa_time_fixed.nc')
  ...
  config['IO']['co2_file']             = os.path.join(input_data_path, 'co2_time_fixed.nc')
  config['IO']['proj_co2_file']        = os.path.join(input_data_path, 'projected_co2_CC_CCSM4_85_time_fixed.nc')
