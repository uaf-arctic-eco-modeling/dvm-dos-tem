...
def csv_get_pftnames(data):
  ...
  is formatted according to the csv_specification_v0. See help for the
  csv_specification_v0() function.
...
def csv_find_section_starts(data):
  ...
  (docstring) for csv_specification_v0().

  Parameters
  ----------
  data : list of strings, required
    Assumed to be a list generated by reading a csv file that is
    formatted as in csv_specification_v0.
...
def csv_get_section(data, start):
  ...
  Assumes that `data` is a list of lines read from a csv file. See help 
  (the docstring) for the csv_specification_v0() function to get more details
  ...
  data : list of strings, required
    ...
    described in the docstring for csv_specification_v0()
  start:
...
def format_section(section_data, full_data):
  ...
  See the help for csv_specification_v0() function to find more info on how the
  ...
  section_data : list
    ...
    file must be formatted as described in the docstring for csv_specification_v0().
...
def cmdline_run(args):
  ...
  if args.csv_specification:
    print(csv_specification_v0.__doc__)
    return 0
