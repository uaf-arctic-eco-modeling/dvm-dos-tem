...
calibration_targets = {
  ...
  ## CMT05 Tussock Tundra (updated 2/19/2016, JDC: NPP, Nuptake, Veg from Shaver & Chapin 1991; GPPain NPPain est'd;
  ...
  "tussock tundra": {
    ...
    'GPPAllIgnoringNitrogen':    [  106.20,   54.13,   208.48,   390.40,   7.062,  286.83,  191.84,   172.55,   0.00,   0.00 ], # ingpp     (gC/m2/year)   GPP without N limitation
    'NPPAllIgnoringNitrogen':    [   59.00,   27.06,   104.24,   195.20,   3.508,  136.59,   94.97,    85.42,   0.00,   0.00 ], # innpp     (gC/m2/year)   NPP without N limitation 
    'NPPAll':                    [   34.71,   14.47,    55.74,   104.39,   1.876,   68.29,   48.70,    43.81,   0.00,   0.00 ], # npp       (gC/m2/year)   NPP with N limitation
