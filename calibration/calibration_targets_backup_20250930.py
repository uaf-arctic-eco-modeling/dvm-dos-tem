...
calibration_targets = {
 ...
 ## Prepared from US-Prr
  ...
  "deciduous forest": {
    ...
    'GPPAllIgnoringNitrogen':    [  0.37,         61.56,       221.49,    16.5,    9.54,      0.0,    0.0,  0.0,    0.0], # ingpp (gC/m2/year)   GPP without N limitation
    'NPPAllIgnoringNitrogen':    [  0.18,         30.78,        110.74,   8.26,    4.77,     0.0,    0.0, 0.0,    0.0], # innpp (gC/m2/year)   NPP without N limitation
    'NPPAll':                    [  0.15,         24.62,        88.59,      6.61,  3.82,       0.0,    0.0,   0.0,    0.0 ], # npp (gC/m2/year)   NPP with N limitation
  ...
  "BONA black spruce forest": {
    ...
    'GPPAllIgnoringNitrogen':    [  205.91,       56.64,        29.90,    410.79,    64.01,      0.0,    0.0,  0.0,    0.0], # ingpp (gC/m2/year)   GPP without N limitation
    'NPPAllIgnoringNitrogen':    [  102.96,       28.32,        14.95,    205.39,   32.00,     0.0,    0.0, 0.0,    0.0], # innpp (gC/m2/year)   NPP without N limitation
    'NPPAll':                    [  82.36,       22.66,        11.96,      164.32,    25.60,       0.0,    0.0,   0.0,    0.0 ], # npp (gC/m2/year)   NPP with N limitation
    'Nuptake':                   [  0.67,         0.17,         0.17,        0.22,     0.42,       0.0,    0.0,   0.0,    0.0 ], # nuptake (gN/m2/year)
    'VegCarbon': {
