...
echo "Add openblas library to link step..."
sed -e 's/-lpthread -lreadline/-lpthread -lopenblas -lreadline/' Makefile > Makefile.tmp && mv Makefile.tmp Makefile


echo "Changing include path for lapacke library..."
